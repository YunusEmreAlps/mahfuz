...
export function ViewModeNormalIcon({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
...
export function ViewModeWbwIcon({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
...
export function ViewModeMushafIcon({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
...
export function SurahTypeIcon({ className = "h-[18px] w-[18px]" }: IconProps) {
  return (
...
export function PageTypeIcon({ className = "h-[18px] w-[18px]" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function JuzTypeIcon({ className = "h-[18px] w-[18px]" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function VerseTypeIcon({ className = "h-[18px] w-[18px]" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
